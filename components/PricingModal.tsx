  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <motion.div 
        ...
        className="relative w-full max-w-4xl bg-[#151c2c] rounded-2xl shadow-2xl border border-[#252f3f] overflow-hidden max-h-[90vh] overflow-y-auto"
      >
        {/* Header */}
        <div className="bg-gradient-to-r from-[#4f7eff] to-[#6366f1] p-5 md:p-6 text-center">
          <h2 className="text-xl md:text-2xl font-bold text-white mb-1">Get More Credits</h2>
          <p className="text-blue-100 text-sm">Select a pack and join the waitlist</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {PACKAGES.map((pkg) => (
              <motion.div
                ...
                className={`relative bg-[#0f1520] rounded-xl p-5 border-2 cursor-pointer transition-all ${
              ...
              >
                ...
                <div className="text-center mb-4">
                  ...
                  <div className="text-[#4f7eff] font-semibold">
                    {pkg.credits} Credits
                  </div>
