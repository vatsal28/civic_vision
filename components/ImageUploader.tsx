  ...
  return (
    <div className="w-full relative group">
      ...
      <div
        ...
        className={`relative w-full aspect-[21/9] min-h-[400px] rounded-[2rem] flex flex-col items-center justify-center transition-all duration-300 border overflow-hidden
          ${isDragging 
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center pointer-events-none p-6 text-center">
          <div className={`p-5 rounded-full bg-gradient-to-br from-cyan-500/20 to-blue-600/20 mb-6 transition-transform duration-300 border border-cyan-500/30 shadow-[0_0_30px_rgba(6,182,212,0.2)] ${isDragging ? 'scale-110' : ''}`}>
